...
COMMAND_FACTORY_METHODS = [
    ...
    ("alignment_outlier_regions", "AlignmentOutlierRegions"),
    ...
    ("projected_covarying_rates", "ProjectedCovaryingRates"),
    ("episodic_rate_covariation", "EpisodicRateCovariation"),
...
class TestPhykitCliDispatch:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("alignment_outlier_regions", "alignment_outlier_regions"),
            ...
            ("projected_covarying_rates", "projected_covarying_rates"),
            ("episodic_rate_covariation", "episodic_rate_covariation"),
