...
"""
    ...
    def test_lazy_numpy_caches_resolved_attributes(self):
        lazy_np = alignment_entropy_module._LazyNumpy()
    ...
    def test_entropy_count_totals_use_array_reduction_for_common_counts(
        ...
        observed = alignment_entropy_module._entropy_count_totals(counts)
    ...
    def test_entropy_count_totals_preserve_long_narrow_sum_path(
        ...
        original_sum = alignment_entropy_module.np.sum
        calls = []
        ...
        monkeypatch.setattr(alignment_entropy_module.np, "sum", sum_spy)
