...
| `PGLS`/`FitContinuous`/`PhyloLogistic`/`PhylogeneticGLM`/`PhylogeneticOrdination` read-only diagonal extraction | 2 / 8 / 64 / 512 / 2048 square matrices, side-by-side previous `np.diag(matrix)` wrapper | 0.000001570s / 0.000001338s / 0.000001205s / 0.000000862s / 0.000000824s | 0.000000122s / 0.000000121s / 0.000000160s / 0.000000093s / 0.000000093s | 12.88x / 11.05x / 7.52x / 9.26x / 8.82x |
