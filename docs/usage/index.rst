...
- :ref:`Codon dN/dS <cmd-codon_dnds>`: Pairwise synonymous and nonsynonymous substitution-rate estimates
...
- :ref:`Chronogram <cmd-chronogram>`: Time-calibrated tree with geological timescale (rectangular or circular)
...
- :ref:`Codon dN/dS <cmd-codon_dnds>`: Pairwise dN, dS, and omega estimates from a codon alignment
...
Function names: codon_dnds; dnds; dn_ds; kaks |br|
Command line interface: pk_codon_dnds; pk_dnds; pk_dn_ds; pk_kaks
...
############################
Function names: phylo_anova; panova; phylo_manova; pmanova |br|
Command line interface: pk_phylo_anova; pk_panova; pk_phylo_manova; pk_pmanova
...
SIMMAP summary
##############
Function names: simmap_summary; smsummary; describe_simmap |br|
Command line interface: pk_simmap_summary; pk_smsummary; pk_describe_simmap
